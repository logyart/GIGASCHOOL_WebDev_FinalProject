...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./core */ "./src/ts/xpage/core.ts"), __webpack_require__(/*! ./Element */ "./src/ts/xpage/Element.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, core_1, Element_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var setSameHeights = function (containerSelector, targetSelector) {
        core_1.default.each(containerSelector, function (el) {
            new Element_1.default(el.querySelectorAll(targetSelector)).height(Math.max.apply(Math, new Element_1.default(el.querySelectorAll(targetSelector)).map(function (value) {
