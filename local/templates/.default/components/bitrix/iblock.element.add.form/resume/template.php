...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
	<input type="hidden" name="PROPERTY[NAME][0]" value="Элемент <?=date('c')?>">

	<input type="hidden" name="PROPERTY[13][0]" value="<?=CIBlockElement::GetById($GLOBALS['VACANCY_ID'])->GetNext()['NAME']?>">
    <?=bitrix_sessid_post()?>
